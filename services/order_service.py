        ...
        if order.payment_id:
            try:
                async with httpx.AsyncClient() as client:
                    ...
                    logger.info(f"Successfully refunded payment {order.payment_id} for order {order_id}, refund ID: {refund_data.get('id')}")
                ...
                raise ValueError(f"Unexpected error during payment refund: {e}")
