...
class OrderService:
    ...
    async def _refund_payment(self, payment_id: UUID, refund_amount: Decimal) -> dict:
        """
        ...
        refund_data = {
            ...
            "reversal_amount_cents": int(refund_amount * 100),  # Convert to cents
            "reversal_notes": "Order cancellation refund"
        }

        timeout = 10.0  # Payment operations may take longer
